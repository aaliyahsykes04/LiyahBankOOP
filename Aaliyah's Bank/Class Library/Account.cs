...
namespace Class_Library
{
    public class Account
    {
        ...
        //get and set say that public data attribute can be changed 
        ...
        //constructor-this is what is called to do things 
        public Account()
        {
            AccountNumber = 0;
            OwnerName = "Unknown";
        ...
        public virtual bool Withdraw(decimal amount)
        {
            ...
            {
                throw new ArgumentException("Error - Withdrawl amount must be positive or account inactive.");
            }
            Balance += amount;
            transactionHistory.Add($"Withdrawl:{amount: C} on {DateTime.Now}");
            return true;
        }
        ...
        {
            IsActive = false;
            transactionHistory.Add($"Account closed on {DateTime.Now} Reasonn {reason}");
        }
    }
}
